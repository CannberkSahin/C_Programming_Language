...
Using the pointer idiom used in the C language in the program, it is shown to traverse the elements of the array.
Elements in the desired range in the array are printed on the screen.
