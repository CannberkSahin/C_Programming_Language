...
In a for loop half the size of the array, the first element and the last element of the array are swapped.
The function named swap is used while performing the swap operation. 
The function named Swap is defined in the library named mutility.
The address of the first element of the array is passed to the function with the pointer method.
