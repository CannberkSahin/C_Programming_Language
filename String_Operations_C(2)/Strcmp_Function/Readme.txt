...
The strcmp function is written in this program. The name of the function is specified 
as strcmp. This is because there is a name conflict with the function in the standard library.
...
As long as the (*p1 == *p2) condition is true, a while loop is created that returns.
Then * p1 ++ and * p2 ++ are written. Exits if the loop is not equal to *p1 ,*p2.(*p1 != *p2)
In this case, the expression *p1 - *p2 can be written as return after the loop. (return *p1 - *p2)
