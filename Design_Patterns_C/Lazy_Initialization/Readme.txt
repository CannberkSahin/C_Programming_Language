...
n software engineering, a design pattern is a general repeatable solution to a 
...
for how to solve a problem that can be used in many different situations.Design 
...
in the implementation. Reusing design patterns helps to prevent subtle issues that can cause 
major problems and improves code readability for coders and architects familiar with the patterns.
In this program, a simple lazy initialization design pattern has been implemented.
